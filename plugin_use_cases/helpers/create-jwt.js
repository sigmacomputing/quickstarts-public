...
/**
 * generateJwt - Generates a signed Sigma JWT for plugin embedding.
 *
 ...
 * @param {string[]} [options.teams] - Optional teams array for user provisioning
 * @returns {string} A signed JWT token.
 */
function generateJwt({ embedUrl, mode, sub, permissions, teams }) {
  if (!sub) {
  ...
  // Add teams for user provisioning if provided
  ...
  if (process.env.DEBUG === "true") {
    console.log("Plugin JWT payload:", payload);
    console.log("Plugin JWT for:", payload.sub);
  }
