// This script will change an members email address, based on the memberId defined in the .env file
...
const newemail = process.env.EMAIL; // The new account type you want to assign
...
async function updateMemberAccountType() {
  ...
  try {
    ...
    const response = await axios.patch(requestURL, {
      email: newemail, // Data payload for the PATCH request
    }, {
      headers: {
